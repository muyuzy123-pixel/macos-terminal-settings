...
The source repository is private. Repository collaborators can report concerns through its restricted-access issue tracker; a public security-reporting destination will be configured if public distribution is later authorized. Do not post credentials, private preference exports, undo/journal files, or exploit details in public issues. Ordinary non-sensitive defects can include the app version, macOS version, affected feature ID, expected behavior, and a minimal redacted reproduction.
